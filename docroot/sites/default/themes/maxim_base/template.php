...
function maxim_base_form_alter(&$form, &$form_state, $form_id) {
  if ($form_id == 'search_block_form') {
    ...
    $form['search_block_form']['#attributes']['onblur'] = "if (this.value == '') {jQuery(this).css('width','100px'); this.value = 'Search';}";
    $form['search_block_form']['#attributes']['onfocus'] = "jQuery(this).css('width','150px'); if (this.value == 'Search') {this.value = '';}";
  }
} 
