...
jQuery(function(){
  ...
  // can't for the life of me get the contexts straightened out. for some reson semifinals displays 2 sliders. remove week slider if semi/finals and remove semis if finals
  if ((jQuery(".hotties-slider-semifinals").length) || ((jQuery(".hotties-slider-finals").length)))  {
    jQuery(".hotties-slider-nonfinalist").remove();
    
    if (jQuery(".hotties-slider-finals").length) {
