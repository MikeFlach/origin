...
<div id="mxm_widget_girl_{$rid}" class="mxm-widget-girl">
...
HTMLBLOCK;
$jsblock = <<<JSBLOCK
  var mxm_widget_{$rid}=document.getElementById("mxm_widget_girl_{$rid}");
  if(mxm_widget_{$rid}.offsetWidth < 210){mxm_widget_{$rid}.className+=" mxm-widget-girl-sm";}
JSBLOCK;
