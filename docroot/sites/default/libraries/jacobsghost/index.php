...
<style>
#age {  padding:4px; background: url('images/formbg.png')no-repeat center center; 
...
#age div h3 { color:#f0f0f0; text-transform:uppercase; }
...
#day-tag, #month-tag, #year-tag { position: relative; display: inline-block; }
...
select { display:inline-block; text-align: center; }
...
.button-red:hover{
  background-image: -webkit-gradient(linear, left top, left bottom, from(#9B2426), to(#D46061));
}
...
<body data-role="body" >
	...
	<div data-role="page" id="index">
      ...
      <li rel="image" class="widget widget-type-image box-image " id="widget1" ><div class="widget-content"><div class="image"><img src="images/JACOBS_STORM_02_8.png" alt=""/></div></div></li>
      <li>
        <!-- Age Gate -->
        <div id="age"><div>

<h3>YOU MUST BE OF LEGAL DRINKING AGE<br>TO ENJOY JIM BEAM PRODUCTS.</h3>
...
<span id="month-tag"><select id="dob-month" name="dob-month">
