...
Drupal.DART.tag = function(tag) {
  ...
  var tagname = tag_method == 'adj' ? 'script' : 'iframe';
  var options = tag_method == 'adj' ? 'type="text/javascript"' : 'frameborder="0" scrolling="no" width="' + tag.sz.split("x")[0] + '" height="' + tag.sz.split("x")[1] + '"';
